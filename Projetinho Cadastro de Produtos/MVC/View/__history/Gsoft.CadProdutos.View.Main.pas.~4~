...
begin
  ...
  else {ShowMessage('Não há produto para calcular o valor!');}
  Application.MessageBox('Não há produto para calcular o valor!', 'Erro ao Calcular', 0);
end;
...
begin
  ...
  begin
    ShowMessage('Não existe produto para ser alterada!');
  end;
...
begin
  ...
  begin
    ShowMessage('Pessoa não selecionada')
  end;
end;
